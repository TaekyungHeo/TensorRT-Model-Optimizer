...
def svdquant(
    ...
    **kwargs,
    ...
    def postprocess(module, name):
        ...
        vt = vt[:lowrank]
        module.weight_quantizer.svdquant_lora_a = vt.to(dtype=original_dtype, device=original_device)
        module.weight_quantizer.svdquant_lora_b = us.to(dtype=original_dtype, device=original_device)
